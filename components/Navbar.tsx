        ...
        <nav className="bg-white shadow-md py-4 border-b border-gray-200 ">
            ...
            <div className="container mx-auto flex justify-between items-center px-6 lg:px-8">
                <Link href={"/trips"} className="flex items-center">
                    ...
                    <span className="text-2xl font-bold text-gray-800"> {" "} GoGoPlan </span>
                </Link>
                <div className="flex items-center space-x-4">
                    {  session ? (
                        <><Link href={"/trips"} className="text-slate-900 hover:text-sky-900">My Trips</Link>
                            ...
                            <button onClick={logout} className="flex items-center justify-center bg-gray-800 hover:bg-gray-900 text-white p-2 rounded-sm cursor-pointer">
                                Sign Out
                            </button></>
                     ) :
